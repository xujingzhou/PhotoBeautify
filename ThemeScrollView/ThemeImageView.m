...
- (void)initialize
{
    ...
    _themeNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 15)];
    self.themeNameLabel.font = [UIFont systemFontOfSize:12.0];
    self.themeNameLabel.center = CGPointMake(self.bounds.size.width/2, self.thumbImageView.frame.size.height+13);
